package com.ritchie.middleware.redis.listener;

import com.ritchie.middleware.redis.entity.TaskItem;
...
/**
 * @author created by Ritchie at 2020/4/30 14:11
 * 用于RedisQueue的消费
 */
@Component
@Slf4j
public class RedisDelayQueueListener implements ApplicationRunner {
    ...
    private void ListenDelayQueue() {
        for (; ; ) {
             ...
             * count : 取几个
             */
            Set<String> tasks = stringRedisTemplate.opsForZSet().rangeByScore(Constant.DELAY_QUEUE_KEY,
